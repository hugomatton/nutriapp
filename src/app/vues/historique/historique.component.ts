...
import {
  NutriOrder,
  NutriorderService,
} from 'src/app/services/nutriOrderPatient.service';
...
export class HistoriqueComponent {
  ...
  ngOnInit(): void {
    ...
    this.nutriOrderService
      .getNutriOrdersByOrderer(ordererReference)
      .subscribe((data: NutriOrder[]) => {
        this.plans = data;
        for (let plan of data) {
          ...
          this.patientService
            ...
            .subscribe((res: any) => {
              ...
              console.log(this.plansWithPatients);
            });
        }
      });
  }
